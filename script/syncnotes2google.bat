...
e:\appl\JavaSDK_16_e\bin\java -Djava.library.path=${NOTES_HOME} -classpath %cPath% -Dhttp.proxyHost=www-proxy -Dhttp.proxyPort=8080 -Dhttps.proxyHost=www-proxy -Dhttps.proxyPort=8080 com.googlecode.syncnotes2google.SyncNotes2Google 
